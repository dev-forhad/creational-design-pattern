...
namespace WebApplication.Controllers
{
    public class EmployeeTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type")] EmployeeType employeeType)
        {
